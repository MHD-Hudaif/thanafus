<?php
$pageTitle = 'Event & Musabaqa Management';
...
<div class="main-content">
    <div class="topbar">
        <div>
            <div class="page-title"><i class="fa-solid fa-calendar-days mr-2" style="color:var(--accent);"></i> Musabaqa Events &amp; Management</div>
        ...
        <form method="GET" class="form-grid" id="search-form">
            ...
            <div class="form-actions full-width">
                ...
                <?php if ($search !== '' || $statusFilter !== 'all'): ?>
                    <a class="btn btn-secondary btn-md" href="<?= app_url('/admin/index.php') ?>">Clear</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
