...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf_token($_POST['csrf_token'] ?? null)) {
        ...
        admin_redirect('/admin/printer/chest-numbers.php');
    }
...
<div class="main-content">
    <div class="topbar">
        ...
        <div class="flex gap-2 flex-wrap">
            ...
            <a href="<?= app_url('/admin/printer/index.php') ?>" class="btn btn-secondary btn-md"><i class="fa-solid fa-chevron-left mr-1"></i> Overview</a>
        </div>
    </div>
    ...
    <div class="panel mb-6">
        <form method="GET" class="form-grid" id="search-form">
            ...
            <div class="form-actions full-width">
                ...
                <?php if ($search !== ''): ?><a href="<?= app_url('/admin/printer/chest-numbers.php') ?>" class="btn btn-secondary btn-md">Clear</a><?php endif; ?>
            </div>
        </form>
    </div>
    ...
    <div class="modal-box modal-lg">
        <div class="modal-header">
            <div>
                ...
                <div class="page-subtitle">Order: each team, sorted class-wise, then the next team.</div>
            </div>
