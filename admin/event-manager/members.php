...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf_token($_POST['csrf_token'] ?? null)) {
        ...
        admin_redirect('/admin/event-manager/members.php', ['team' => $activeTeamId]);
    }
...
<div class="main-content">
    <div class="topbar">
        ...
        <a href="<?= app_url('/admin/event-manager/add-members.php') ?>?team=<?= $activeTeamId ?>" class="btn btn-success btn-md"><i class="fa-solid fa-plus"></i> Add Members</a>
    </div>
    ...
    <div class="panel mb-6">
        <form method="GET" class="form-grid" id="search-form">
            ...
            <div class="form-actions full-width"><button class="btn btn-secondary btn-md" type="submit"><i class="fa-solid fa-filter"></i> Filter</button><?php if ($search !== '' || $statusFilter !== 'active'): ?><a href="<?= app_url('/admin/event-manager/members.php') ?>?team=<?= $activeTeamId ?>" class="btn btn-secondary btn-md">Clear</a><?php endif; ?></div>
        </form>
    </div>
