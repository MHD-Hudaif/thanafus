...
<div class="main-content">
    <div class="topbar">
        ...
        <div class="flex gap-2 flex-wrap">
            ...
            <a href="<?= app_url('/admin/event-manager/teams.php') ?>" class="btn btn-secondary btn-md"><i class="fa-solid fa-people-group"></i> Teams</a>
        </div>
    </div>
    ...
    <div class="panel mb-6">
        <form method="GET" class="form-grid" id="search-form">
            ...
            <div class="form-actions full-width">
                ...
                <?php if ($search !== ''): ?><a href="<?= app_url('/admin/event-manager/chest-numbers.php') ?>" class="btn btn-secondary btn-md">Clear</a><?php endif; ?>
            </div>
        </form>
    </div>
