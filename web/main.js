...
function header(page) {
  return `<header class="site-header">
    ...
    <div class="header-account-actions"><div class="festival-date"><span>Festival day</span><b>${data.event?.date || '18 August 2026'}</b></div><a class="visitor-logout visitor-logout-floating" href="auth/logout.php" aria-label="Sign out" style="text-decoration: none;">Sign out</a></div>
  </header>`;
}
